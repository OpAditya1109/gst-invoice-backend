...
export class ApiSettingsV1 extends BaseSettings {
    constructor({ apiKey, dispatcher, }) {
        ...
        if (!this.apiKey || this.apiKey.length === 0) {
            throw new MindeeConfigurationError("Your V1 API key could not be set, check your Client Configuration\n."
    ...
    apiKeyFromEnv() {
        ...
        if (envVarValue) {
            logger.debug("Set the V1 API key from the environment");
            return envVarValue;
        }
        return "";
    }
