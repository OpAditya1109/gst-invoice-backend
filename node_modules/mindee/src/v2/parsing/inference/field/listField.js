    ...
    get simpleItems() {
        ...
        for (const item of this.items) {
            if (item instanceof SimpleField) {
                ...
                throw new MindeeDeserializationError(`All items must be SimpleField, found item of type ${item.constructor.name}.`);
            }
        }
        return result;
    }
    ...
    get objectItems() {
        ...
        for (const item of this.items) {
            if (item instanceof ObjectField) {
                ...
                throw new MindeeDeserializationError(`All items must be ObjectField, found item of type ${item.constructor.name}.`);
            }
        }
        return result;
    }
